...
public class Signal extends Service implements OnErrorListener,
    ...
    public void showNotification() {
        ...
        notifyBuilder = new Notification.Builder(this.context)
                ...
                // .setSmallIcon(android.R.mipmap.ic_launcher) // TODO Use app icon instead
                .setContentText("")
                .setOngoing(true)
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel("com.audioStreaming", "Audio Streaming", NotificationManager.IMPORTANCE_LOW);
